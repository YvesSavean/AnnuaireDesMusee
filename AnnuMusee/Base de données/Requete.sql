...
insert into musee(nom,ville,pays,nbVisiteur,description) values('Mus�e du Louvre','Paris','France',8500000 ,'la description');
insert into musee(nom,ville,pays,nbVisiteur,description) values('British Museum','Londres','Royaume-Uni',5842138,'la description');
insert into musee(nom,ville,pays,nbVisiteur,description) values('Metropolitan Museum of Art','New York','�tats-Unis',5216988 ,'la description');
